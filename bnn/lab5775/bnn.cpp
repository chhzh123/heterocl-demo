        ...
        #pragma HLS pipeline
          for (ap_int<32> ry1 = 0; ry1 < 3; ++ry1) {
            for (ap_int<32> rx1 = 0; rx1 < 3; ++rx1) {
              sum1 = ((ap_int<10>)(((ap_int<33>)(((((((ap_int<33>)1 - ((ap_int<33>)rx1)) <= ((ap_int<33>)w2)) && (((ap_int<33>)w2) < ((ap_int<33>)9 - ((ap_int<33>)rx1)))) && (((ap_int<33>)1 - ((ap_int<33>)ry1)) <= ((ap_int<33>)h2))) && (((ap_int<33>)h2) < ((ap_int<33>)9 - ((ap_int<33>)ry1)))) ? ((ap_int<32>)(((1 - ((ap_int<32>)(pad1[(((w2 + rx1) + ((h2 + ry1) * 10)) + (rc * 100))] ^ w_conv2[(((rx1 + (ry1 * 3)) + (rc * 9)) + (c2 * 144))]))) << 1) + -1)) : ((ap_int<32>)0))) + ((ap_int<33>)sum1)));
            }
          }
        }
        conv2 = sum1;
  ...
  for (ap_int<32> i5 = 0; i5 < 1; ++i5) {
    ...
    #pragma HLS pipeline
      ...
      for (ap_int<32> ra10 = 0; ra10 < 512; ++ra10) {
        reducer6 = (((float)(((1 - ((ap_int<32>)(flatten[(ra10 + (i5 * 512))] ^ w_fc1[(ra10 + (j1 * 512))]))) << 1) + -1)) + reducer6);
      }
  ...
  for (ap_int<32> i6 = 0; i6 < 1; ++i6) {
    ...
    #pragma HLS pipeline
      ...
      for (ap_int<32> ra11 = 0; ra11 < 256; ++ra11) {
        reducer7 = (((float)(((1 - ((ap_int<32>)(dense_relu[(ra11 + (i6 * 256))] ^ w_fc2[(ra11 + (j2 * 256))]))) << 1) + -1)) + reducer7);
      }
      fc2[(j2 + (i6 * 10))] = ((reducer7 * 8.838835e-02f) + b_fc2[j2]);
    }
  }
}
