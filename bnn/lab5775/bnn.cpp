...
void default_function(ap_int<10> input_image[100*1*16*16], ap_uint<1> w_conv1[16*1*3*3], float bn_t1[16*16*16], ap_uint<1> w_conv2[32*16*3*3], float bn_t2[32*8*8], ap_uint<1> w_fc1[256*512], float b_fc1[256], ap_uint<1> w_fc2[10*256], float b_fc2[10], float binary_dense[100*10]) {
  ...
  ap_int<10> batch_norm_threshold[409600];
  for (ap_int<32> i1 = 0; i1 < 100; ++i1) {
    for (ap_int<32> c = 0; c < 16; ++c) {
      for (ap_int<32> h = 0; h < 16; ++h) {
        for (ap_int<32> w = 0; w < 16; ++w) {
          batch_norm_threshold[(((w + (h * 16)) + (c * 256)) + (i1 * 4096))] = ((ap_int<10>)((bn_t1[((w + (h * 16)) + (c * 256))] < ((float)conv1[(((w + (h * 16)) + (c * 256)) + (i1 * 4096))])) ? 1 : 0));
        }
      }
    }
  }
    ...
    for (ap_int<32> not_zero = 0; not_zero < 16; ++not_zero) {
      for (ap_int<32> index_tuple1 = 0; index_tuple1 < 16; ++index_tuple1) {
        for (ap_int<32> i2 = 0; i2 < 16; ++i2) {
          pad[(((i2 + (index_tuple1 * 16)) + (not_zero * 256)) + (indices1 * 4096))] = batch_norm_threshold[(((i2 + (index_tuple1 * 16)) + (not_zero * 256)) + (indices1 * 4096))];
        }
      }
    }
  }
  ap_int<10> binary_max_pool2d[102400];
    ...
    for (ap_int<32> c1 = 0; c1 < 16; ++c1) {
      for (ap_int<32> h1 = 0; h1 < 8; ++h1) {
        for (ap_int<32> w1 = 0; w1 < 8; ++w1) {
          ...
          binary_max_pool2d[(((w1 + (h1 * 8)) + (c1 * 64)) + (i3 * 1024))] = ((ap_int<10>)((0 < ((ap_int<32>)reducer4)) ? 1 : 0));
        }
      }
    }
  }
  ...
  ap_int<10> batch_norm_threshold1[204800];
  for (ap_int<32> i5 = 0; i5 < 100; ++i5) {
    for (ap_int<32> c2 = 0; c2 < 32; ++c2) {
      for (ap_int<32> h2 = 0; h2 < 8; ++h2) {
        for (ap_int<32> w2 = 0; w2 < 8; ++w2) {
          batch_norm_threshold1[(((w2 + (h2 * 8)) + (c2 * 64)) + (i5 * 2048))] = ((ap_int<10>)((bn_t2[((w2 + (h2 * 8)) + (c2 * 64))] < ((float)conv2[(((w2 + (h2 * 8)) + (c2 * 64)) + (i5 * 2048))])) ? 1 : 0));
        }
      }
    }
  }
    ...
    for (ap_int<32> not_zero2 = 0; not_zero2 < 32; ++not_zero2) {
      for (ap_int<32> index_tuple3 = 0; index_tuple3 < 8; ++index_tuple3) {
        for (ap_int<32> i6 = 0; i6 < 8; ++i6) {
          pad1[(((i6 + (index_tuple3 * 8)) + (not_zero2 * 64)) + (indices3 * 2048))] = batch_norm_threshold1[(((i6 + (index_tuple3 * 8)) + (not_zero2 * 64)) + (indices3 * 2048))];
        }
      }
    }
  }
  ap_int<10> binary_max_pool2d1[51200];
    ...
    for (ap_int<32> c3 = 0; c3 < 32; ++c3) {
      for (ap_int<32> h3 = 0; h3 < 4; ++h3) {
        for (ap_int<32> w3 = 0; w3 < 4; ++w3) {
          ...
          binary_max_pool2d1[(((w3 + (h3 * 4)) + (c3 * 16)) + (i7 * 512))] = ((ap_int<10>)((0 < ((ap_int<32>)reducer5)) ? 1 : 0));
        }
      }
    }
  }
  ...
  for (ap_int<32> i8 = 0; i8 < 100; ++i8) {
    for (ap_int<32> j = 0; j < 512; ++j) {
      flatten[(j + (i8 * 512))] = binary_max_pool2d1[(((((j / 128) * 4) + ((j / 32) % 4)) + ((j % 32) * 16)) + (i8 * 512))];
    }
  }
  ap_int<10> binary_dense1[25600];
  for (ap_int<32> i9 = 0; i9 < 100; ++i9) {
    for (ap_int<32> j1 = 0; j1 < 256; ++j1) {
      ...
      binary_dense1[(j1 + (i9 * 256))] = ((ap_int<10>)reducer6);
    }
  }
  float binary_dense2[25600];
  for (ap_int<32> i10 = 0; i10 < 100; ++i10) {
    for (ap_int<32> j2 = 0; j2 < 256; ++j2) {
      binary_dense2[(j2 + (i10 * 256))] = ((((float)binary_dense1[(j2 + (i10 * 256))]) * 6.250000e-02f) + b_fc1[j2]);
    }
  }
  ap_int<10> binary_dense3[25600];
  for (ap_int<32> i11 = 0; i11 < 100; ++i11) {
    for (ap_int<32> j3 = 0; j3 < 256; ++j3) {
      binary_dense3[(j3 + (i11 * 256))] = ((ap_int<10>)((0.000000e+00f < binary_dense2[(j3 + (i11 * 256))]) ? 1 : 0));
    }
  }
  ap_int<10> binary_dense4[1000];
  for (ap_int<32> i12 = 0; i12 < 100; ++i12) {
    for (ap_int<32> j4 = 0; j4 < 10; ++j4) {
      float reducer7;
      reducer7 = 0.000000e+00f;
      for (ap_int<32> ra11 = 0; ra11 < 256; ++ra11) {
        reducer7 = (((float)(((1 - ((ap_int<32>)(binary_dense3[(ra11 + (i12 * 256))] ^ w_fc2[(ra11 + (j4 * 256))]))) << 1) + -1)) + reducer7);
      }
      binary_dense4[(j4 + (i12 * 10))] = ((ap_int<10>)reducer7);
    }
  }
  for (ap_int<32> i13 = 0; i13 < 100; ++i13) {
    for (ap_int<32> j5 = 0; j5 < 10; ++j5) {
      binary_dense[(j5 + (i13 * 10))] = ((((float)binary_dense4[(j5 + (i13 * 10))]) * 8.838835e-02f) + b_fc2[j5]);
    }
  }
}
