...
#include <stdint.h>
#include "kernel.h"
  void test(hls::stream<ap_fixed<20, 10> >& b_fc2_channel, hls::stream<ap_uint<1> >& w_conv1_channel, hls::stream<ap_uint<1> >& input_image_channel, hls::stream<ap_fixed<20, 10> >& bn_t1_channel, hls::stream<ap_uint<16> >& w_conv2_channel, hls::stream<ap_fixed<20, 10> >& bn_t2_channel, hls::stream<ubit32 >& w_fc1_channel, hls::stream<ap_fixed<20, 10> >& b_fc1_channel, hls::stream<ubit32 >& w_fc2_channel, hls::stream<ap_fixed<20, 10> >& fc2_channel) {
  #pragma HLS INTERFACE axis port=b_fc2_channel offset=slave bundle=gmem0
  #pragma HLS INTERFACE axis port=w_conv1_channel offset=slave bundle=gmem1
  ...
  #pragma HLS INTERFACE axis port=bn_t2_channel offset=slave bundle=gmem5
  #pragma HLS INTERFACE axis port=w_fc1_channel offset=slave bundle=gmem6
  #pragma HLS INTERFACE axis port=b_fc1_channel offset=slave bundle=gmem7
...
LOOP2: for (bit32 w_conv10 = 0; w_conv10 < 16; ++w_conv10) {
...
LOOP3: for (bit32 input_image2 = 0; input_image2 < 16; ++input_image2) {
...
LOOP6: for (bit32 bn_t20 = 0; bn_t20 < 32; ++bn_t20) {
        ...
        #pragma HLS pipeline
          ...
          for (bit32 ry = 0; ry < 3; ++ry) {
            for (bit32 rx = 0; rx < 3; ++rx) {
              conv1_sum = ((ap_int<6>)(((ap_int<34>)(((((((ap_int<33>)1 - ((ap_int<33>)rx)) <= ((ap_int<33>)xx)) && (((ap_int<33>)xx) < ((ap_int<33>)17 - ((ap_int<33>)rx)))) && (((ap_int<33>)1 - ((ap_int<33>)ry)) <= ((ap_int<33>)yy))) && (((ap_int<33>)yy) < ((ap_int<33>)17 - ((ap_int<33>)ry)))) ? (ap_int<6>)((((1U - ((ubit32)conv1_pad[((xx + rx) + ((yy + ry) * 18))])) ^ w_conv1[((rx + (ry * 3)) + (ff * 9))]) << 1) - 1U) : (ap_int<6>)0U)) + ((ap_int<34>)conv1_sum)));
            }
          }
          ...
          for (bit32 conv2_ry = 0; conv2_ry < 3; ++conv2_ry) {
            for (bit32 conv2_rx = 0; conv2_rx < 3; ++conv2_rx) {
              for (bit32 conv2_rb = 0; conv2_rb < 16; ++conv2_rb) {
                conv2_sum = ((ap_int<6>)(((ap_int<34>)(((((((ap_int<33>)1 - ((ap_int<33>)conv2_rx)) <= ((ap_int<33>)xx1)) && (((ap_int<33>)xx1) < ((ap_int<33>)9 - ((ap_int<33>)conv2_rx)))) && (((ap_int<33>)1 - ((ap_int<33>)conv2_ry)) <= ((ap_int<33>)yy1))) && (((ap_int<33>)yy1) < ((ap_int<33>)9 - ((ap_int<33>)conv2_ry)))) ? (((65535U - ((ubit32)(conv2_pad[((xx1 + conv2_rx) + ((yy1 + conv2_ry) * 10))] ^ w_conv2[((conv2_rx + (conv2_ry * 3)) + (ff1 * 9))])))[conv2_rb] << 1) - 1U) : 0U)) + ((ap_int<34>)conv2_sum)));
              }
            }
          }
...
LOOP16: for (bit32 h2 = 0; h2 < 8; ++h2) {
      ...
      #pragma HLS pipeline
        ...
        for (bit32 i4 = 0; i4 < 32; ++i4) {
          bn2_pack(i4, i4) = ((bn_t2[((w2 + (h2 * 8)) + (i4 * 64))] < ((ap_fixed<20, 10>)conv2[((w2 + (h2 * 8)) + (i4 * 64))])) ? 1 : 0);
        }
...
LOOP22: for (bit32 i9 = 0; i9 < 1; ++i9) {
      ...
      #pragma HLS pipeline
        ...
        for (bit32 i10 = 0; i10 < 32; ++i10) {
          fc1_pack(i10, i10) = (((ap_fixed<42, 32>)0 < ((ap_fixed<42, 32>)fc1_bias[(((j4 * 32) + i10) + (i9 * 256))])) ? 1 : 0);
        }
